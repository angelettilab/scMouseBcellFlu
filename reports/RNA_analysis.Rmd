...
```{r}
pdir <- paste0(cdir, 'cell_type_prediction/main_cell_types/')
```

#### Predicted cell types (based on correlation)
```{r, results='asis'}
cat('![](', pdir, 'cell_cluster_pred_correlation_umap.png', '){width=70%}', sep='')
```

#### Predicted cell type composition of each cluster
```{r, results='asis'}
cat('![](', cdir, 'clustering/clustering_', clust, '_umap.png', '){width=40%}', sep='')
cat('![](', pdir, 'cell_cluster_pred_correlation_barplot.png', '){width=60%}', sep='')
```
...
```{r, results='asis'}
cat('![](', pdir, 'removed_clusters_umap.png', '){width=80%}', sep='')
```
...
### Metadata (continuous)
#### UMAP colored by metadata values
```{r, results='asis'}
...
```{r, results='asis'}
cat('##### UMAP with mapped Louvain cluster groups (', clust, ')\n', sep='')
...
```{r}
sdir <- paste0(adir,'04_cluster/cell_type_prediction/')
```
